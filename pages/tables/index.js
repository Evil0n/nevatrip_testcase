...
export default function Index () {
  return <div>
    С предоставленной таблицей будет сложно сделать задание, по этому я решил
    ...
    табличке может быть бесконечно из за отсутствия разделения сущностей. <br/>
    ...
    тз на основе данных из представленных 4 таблиц. Однако в виду того что я занимался исключительно front-end разработкой и у меня нет базы,
    ...
    barcode из таблицы билет колонка баркод <br/>
